---
name: open-pr
description: Compares the current branch against main and drafts a pull request title/body with summary and test plan. Use when the user asks to open a PR, draft a PR, prepare PR notes, or review branch changes before creating a PR.
---
